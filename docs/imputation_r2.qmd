...
Because most of the values are concentrated in the lower range of sap flux density (Fig SX?), the relative difference between the sum of observed sap flux and the sum of re-imputed sap flux across all the range is only `r rel_diff`%.
