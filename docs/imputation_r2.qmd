...
To assess the accuracy of the imputation, we randomly removed values (*n* = `r n_miss`) from the imputed dataset, excluding data from September, October, and December 2015 due to their excessive missing values, to create a new dataset with additional missing values.
