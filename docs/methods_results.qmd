...
However, when the xylem-level variation was accounted for, only the relationship between Ks and the coefficient *a* maintained a 95% CI that did not overlap with zero (Fig. `r fig_num("traits_points_main")`B)
