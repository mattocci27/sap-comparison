...
Finally, we scaled $S_{10min}$ to compute annual stand transpiration by summing up $S_{10min}$ for all the trees over two years and normalizing this sum by the area of the stand (800 m^2^).
