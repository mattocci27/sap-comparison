...
source("R/figs.R")
tree_id <- "t04"
clean_raw_df(tar_read(rubber_raw_data_csv), year = 2016, month = 5)
...
source("R/figs.R")
p <- imp_points(
  tar_read(imputed_df_btrans_2015_6), tar_read(rubber_raw_data_csv), year = 2015, month = 6,
  tar_read(imputed_df_btrans_2016_6), tar_read(rubber_raw_data_csv), year = 2016, month = 6,
  depth = FALSE)
p
