...
A bivariate relationship between pressure- and tension-induced flow rates (*K~s~*) was evaluated a standardized major axis (SMA) regression (Warton et al., 2006).
We also examined the effect of pressure types and species on *K~s~* using a Bayesian ANOVA model.
...
For instance, the percentage of variance explained by factor species was calculated as:
