...
In our dataset, *K* values were measured across three soil depths (0-2 cm, 2-4 cm, and 4-6 cm) and four directions (north, south, east, and west).
...
This linear model of sapwood length is also crucial for calculating sap flux at 10-minute intervals ($S_{10min}$) using the equation
