...
# log_ks_s <- withr::with_dir(rprojroot::find_root('_targets.R'),
#     targets::tar_read(stan_data_noxylem_log_ks))$xk[15, 2]

# log_vaf_s <- withr::with_dir(rprojroot::find_root('_targets.R'),
#     targets::tar_read(stan_data_noxylem_log_vaf))$xk[15, 2]
# mean_ks <- mean(d$ks)
# mean_ks <- exp(-0.243)
...
The orignial regression model used the scaled predictor:
$$
