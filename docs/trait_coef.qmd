...
tmp_seg_vaf <- prepare_data(pred_data_seg[[1]]$pred_points, "a_") |> mutate(trait = "log_vaf")
tmp_seg_vaf_b <- prepare_data(pred_data_seg[[1]]$pred_points, "b_") |> mutate(trait = "log_vaf")
tmp_seg_ks <- prepare_data(pred_data_seg[[2]]$pred_points, "a_") |> mutate(trait = "log_ks")
tmp_seg_ks_b <- prepare_data(pred_data_seg[[2]]$pred_points, "b_") |> mutate(trait = "log_ks")
...
# fig_data <- fig_data_sp

# hoge |>
#   filter(str_detect(name, "traits_sp_points"))
