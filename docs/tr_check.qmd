...
post1 <- tar_read(segments_xylem_post_ab_fit_draws_segments_xylem_0.02)
post2 <- tar_read(segments_xylem_post_ab_fit_draws_segments_xylem_0.08)
...
full_df_processed |>
  pull(log_k) |>
  exp() |>
  quantile(c(0.8, 0.9, 0.95), na.rm = TRUE)
