...
```{stan, file=here::here('stan/grainer_without_traits.stan'), echo=TRUE, eval=FALSE, output.var="hoge2"}
```
...
#   targets::tar_read(fit_ab1_draws_grainer_without_traits_sap_all_clean_2)) |>
#   janitor::clean_names()

draws <- withr::with_dir(rprojroot::find_root('_targets.R'),
  targets::tar_read(fit_ab1_draws_grainer_without_traits_sap_all_raw_2)) |>
  janitor::clean_names()

#tar_load(fit_ab1_summary_grainer_without_traits_sap_all_clean_2)
#tar_load(fit_ab1_draws_grainer_without_traits_sap_all_clean_2)
xy_lab <- d |>
...
# draws <- fit_ab1_draws_grainer_without_traits_sap_all_clean_2 |>
#   janitor::clean_names()
```
...
s_002 <- withr::with_dir(rprojroot::find_root('_targets.R'),
  targets::tar_read(fit_ab1_summary_grainer_without_traits_sap_all_raw_0.02)) |>
  janitor::clean_names() |>
  mutate(pressure = "0.02")
s_003 <- withr::with_dir(rprojroot::find_root('_targets.R'),
  targets::tar_read(fit_ab1_summary_grainer_without_traits_sap_all_raw_0.03)) |>
  janitor::clean_names() |>
  mutate(pressure = "0.03")
s_004 <- withr::with_dir(rprojroot::find_root('_targets.R'),
  targets::tar_read(fit_ab1_summary_grainer_without_traits_sap_all_raw_0.04)) |>
  janitor::clean_names() |>
  mutate(pressure = "0.04")
s_005 <- withr::with_dir(rprojroot::find_root('_targets.R'),
  targets::tar_read(fit_ab1_summary_grainer_without_traits_sap_all_raw_0.05)) |>
  janitor::clean_names() |>
  mutate(pressure = "0.05")
s_006 <- withr::with_dir(rprojroot::find_root('_targets.R'),
  targets::tar_read(fit_ab1_summary_grainer_without_traits_sap_all_raw_0.06)) |>
  janitor::clean_names() |>
  mutate(pressure = "0.06")
s_007 <- withr::with_dir(rprojroot::find_root('_targets.R'),
  targets::tar_read(fit_ab1_summary_grainer_without_traits_sap_all_raw_0.07)) |>
  janitor::clean_names() |>
  mutate(pressure = "0.07")
s_008 <- withr::with_dir(rprojroot::find_root('_targets.R'),
  targets::tar_read(fit_ab1_summary_grainer_without_traits_sap_all_raw_0.08)) |>
  janitor::clean_names() |>
  mutate(pressure = "0.08")
s_all <- withr::with_dir(rprojroot::find_root('_targets.R'),
  targets::tar_read(fit_ab1_summary_grainer_without_traits_sap_all_raw_2)) |>
  janitor::clean_names() |>
  mutate(pressure = "all")
...
#a_data <- bind_rows(s_002, s_003, s_004, s_005, s_006, s_007, s_008, s_all) |>
...
#b_data <- bind_rows(s_002, s_003, s_004, s_005, s_006, s_007, s_008, s_all) |>
...
s2_008 <- withr::with_dir(rprojroot::find_root('_targets.R'),
  targets::tar_read(fit_ab1_summary_grainer_without_traits2_sap_all_raw_0.08)) |>
  janitor::clean_names() |>
  mutate(pressure = "0.08")
...
```{r, eval=FALSE}
tar_load(fit_ab_each2_sap_sp_raw_0.08)
tar_load(fit_ab_each_sap_sp_raw_0.08)

fit_ab_each_sap_sp_raw_0.08$fit[[1]]$summary
fit_ab_each2_sap_sp_raw_0.08$fit[[1]]$summary
...
tar_load(fit_ab2_sap_sp_clean_0.03)
tar_load(fit_ab2_sap_sp_clean_0.08)
...
tar_read(fit_ab_summary_grainer_without_traits_sap_all_0.08)
