...
```{r, include=FALSE, eval=FALSE}
s_log_vf <- tar_read(fit_summary_segments_noxylem_traits_sp_simple_log_vf) |> janitor::clean_names()
s_log_dh <- tar_read(fit_summary_segments_noxylem_traits_sp_simple_log_dh) |> janitor::clean_names()
s_log_swc <- tar_read(fit_summary_segments_noxylem_traits_sp_simple_log_swc) |> janitor::clean_names()
s_wood_density <- tar_read(fit_summary_segments_noxylem_traits_sp_simple_wood_density) |> janitor::clean_names()
