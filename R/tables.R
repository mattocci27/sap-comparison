...
clean_all(segments, names_data, "a", "multi_full_a") |>
  full_join(clean_all(segments, names_data, "ln_a", "multi_full_ln_a")) |>
  full_join(clean_all(segments, names_data, "b", "multi_full_b")) |>
  full_join(clean_all(pool, names_data, "a", "pool_full_a")) |>
  full_join(clean_all(pool, names_data, "ln_a", "pool_full_ln_a")) |>
  full_join(clean_all(pool, names_data, "b", "pool_full_b")) |>
