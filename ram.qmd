...
d <- read_csv("data-raw/calibration_raw_data.csv") |>
  ...
  mutate(
    species_name = case_when(
      species_name == "Bauhinia  tenuiflor" ~ "Bauhinia tenuiflor",
      species_name == "Dypsis  lutescen" ~ "Dypsis lutescen",
      TRUE ~ species_name
    )
  )
...
thresholds <- c(0.02, 0.025, 0.03, 0.035, 0.04, 0.05, 0.06, 0.07, 0.08)
...
# Apply it with your dataset `d2` — make sure d2 is defined!
p_all2 <- map2_dfr(
